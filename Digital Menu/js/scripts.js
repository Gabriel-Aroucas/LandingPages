...
$("#finishOrder").on({
    click: () => {
        ...
        if (name.length <= 1) {
            ...
            window.location.href = `https://api.whatsapp.com/send?phone=+5521974447184&text= _Olá_, _Meu pedido é:_ %0A${repass}%0A _Meu nome é:_ *${name}*%0A _A forma de pagamento é:_ *${paymentMode}* .%0A _Meu endereço:_ *${adress}* _Nº_: *${number}* 📬. %0A _O molho é:_ *${sauces}* 🥫%0A _Precisa de troco ? :_ *${exchanged}* 🪙 %0A _Informações Adicionais:_ *${additionalInformation}* 📝`
